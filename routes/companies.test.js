...
describe("POST /companies", function () {
  test("users cannot create a new company if they are not admin", async function () {
  ...
  test("Only admin can create company", async function () {
    const resp = await request(app)
      .post("/companies")
      .send({
        handle: "cnew",
...
describe("DELETE /companies/:handle", function () {
  test("user can't delete company if not admin", async function () {
    const resp = await request(app)
      .delete(`/companies/c1`)
      .send({
        _token: u1Token,
  ...
  test("Admin can delete company", async function () {
    const resp = await request(app)
      .delete(`/companies/c1`)
      .send({
        _token: adminToken,
